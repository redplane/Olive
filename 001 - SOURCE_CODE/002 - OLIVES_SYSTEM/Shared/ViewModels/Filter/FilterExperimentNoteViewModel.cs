...
namespace Shared.ViewModels.Filter
{
    public class FilterExperimentNoteViewModel : IPagination
    {
        ...
        [NumericPropertyCompare("MaxCreate", Comparision = Comparision.LowerEqual, ErrorMessageResourceType = typeof(Language), ErrorMessageResourceName = "ValueMustBeEqualLowerThan")]
