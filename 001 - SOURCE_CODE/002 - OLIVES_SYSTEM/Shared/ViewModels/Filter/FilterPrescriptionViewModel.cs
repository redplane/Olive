...
namespace Shared.ViewModels.Filter
{
    public class FilterPrescriptionViewModel : IPagination
    {
        ...
        /// </summary>
        [InEnumerationsArray(new object[] {NoteResultSort.Created, NoteResultSort.LastModified}, ErrorMessageResourceType = typeof(Language), ErrorMessageResourceName = "ValueMustBeOneOfArray")]
