...
namespace Olives.ViewModels.Filter
{
    public class FilterDoctorViewModel : IPagination
    {
        ...
        /// </summary>
        [InEnumerationsArray(new object[] { FilterDoctorSort.Birthday, FilterDoctorSort.FirstName, FilterDoctorSort.Gender, FilterDoctorSort.LastName }, ErrorMessageResourceType = typeof(Language), ErrorMessageResourceName = "ValueMustBeOneOfArray")]
